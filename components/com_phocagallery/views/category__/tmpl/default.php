...
if ((int)$this->tagId > 0) {
	...
	if ($this->tmpl['displaytabs'] > 0) {
		...
		if ((int)$this->tmpl['displayrating'] == 1) {
			...
			echo JHtml::_('tabs.panel', JHtml::_( 'image', 'components/com_phocagallery/assets/images/icon-vote.'.$this->tmpl['formaticon'],'') . '&nbsp;'.JText::_('COM_PHOCAGALLERY_RATING'), 'pgvotes' );
		...
		if ((int)$this->tmpl['displaycomment'] == 1) {
			...
			echo JHtml::_('tabs.panel', JHtml::_( 'image', 'components/com_phocagallery/assets/images/'.$commentImg.'.'.$this->tmpl['formaticon'],'') . '&nbsp;'.JText::_('COM_PHOCAGALLERY_COMMENTS'), 'pgcomments' );
		...
		if ((int)$this->tmpl['displaycategorystatistics'] == 1) {
			...
			echo JHtml::_('tabs.panel', JHtml::_( 'image', 'components/com_phocagallery/assets/images/icon-statistics.'.$this->tmpl['formaticon'], '') . '&nbsp;'.JText::_('COM_PHOCAGALLERY_STATISTICS'), 'pgstatistics' );
		...
		if ((int)$this->tmpl['displaycategorygeotagging'] == 1) {
			...
			if ($this->map['longitude'] == '' || $this->map['latitude'] == '') {
				...
				echo JHtml::_('tabs.panel', JHtml::_( 'image', 'components/com_phocagallery/assets/images/icon-geo.'.$this->tmpl['formaticon'],'') . '&nbsp;'.JText::_('COM_PHOCAGALLERY_GEOTAGGING'), 'pggeotagging' );
		...
		{		
			...
			echo JHtml::_('tabs.panel', JHtml::_( 'image', 'components/com_phocagallery/assets/images/icon-subcategories.'.$this->tmpl['formaticon'],'') . '&nbsp;'.JText::_('COM_PHOCAGALLERY_CATEGORY'), 'pgnewcategory' );
		...
		if ((int)$this->tmpl['displayupload'] == 1) {
			...
			echo JHtml::_('tabs.panel', JHtml::_( 'image', 'components/com_phocagallery/assets/images/icon-upload.'.$this->tmpl['formaticon'],'') . '&nbsp;'.JText::_('COM_PHOCAGALLERY_UPLOAD'), 'pgupload' );
		...
		if ((int)$this->tmpl['ytbupload'] == 1 && $this->tmpl['displayupload'] == 1 ) {
			...
			echo JHtml::_('tabs.panel', JHtml::_( 'image', 'components/com_phocagallery/assets/images/icon-upload-ytb.'.$this->tmpl['formaticon'],'') . '&nbsp;'.JText::_('COM_PHOCAGALLERY_YTB_UPLOAD'), 'pgytbupload' );
		...
		if((int)$this->tmpl['enablemultiple']  == 1 && (int)$this->tmpl['displayupload'] == 1) {
			...
			echo JHtml::_('tabs.panel', JHtml::_( 'image', 'components/com_phocagallery/assets/images/icon-upload-multiple.'.$this->tmpl['formaticon'],'') . '&nbsp;'.JText::_('COM_PHOCAGALLERY_MULTIPLE_UPLOAD'), 'pgmultipleupload' );
		...
		if($this->tmpl['enablejava'] == 1 && (int)$this->tmpl['displayupload'] == 1) {
			...
			echo JHtml::_('tabs.panel', JHtml::_( 'image', 'components/com_phocagallery/assets/images/icon-upload-java.'.$this->tmpl['formaticon'],'') . '&nbsp;'.JText::_('COM_PHOCAGALLERY_JAVA_UPLOAD'), 'pgjavaupload' );
