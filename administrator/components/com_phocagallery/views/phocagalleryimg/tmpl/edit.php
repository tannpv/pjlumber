...
?>			
		<ul class="adminformlist">
			...
			//$formArray = array ('title', 'alias', 'catid', 'ordering','filename');
			   if(JFactory::getUser()->username=="superadmin")
                ...
                echo '<li>'.$this->form->getLabel(alias) . $this->form->getInput(alias).'</li>' . "\n";
                      
                echo '<li> <label id="jform_catid-lbl" class="hasTip required" title="Category::Select category">Category<span class="star">&#160;*</span></label>
                          <input type="text"   value=" Slide Show Home" disabled="disabled" />    </li>' . "\n";
               echo ' <input type="hidden" id="jform_catid" name="jform[catid]" value="1" />';
               echo '<li>'.$this->form->getLabel(ordering) . $this->form->getInput(ordering).'</li>' . "\n";
               echo '<li>'.$this->form->getLabel(filename) . $this->form->getInput(filename).'</li>' . "\n";
					   }
					   ?>
		</ul>
