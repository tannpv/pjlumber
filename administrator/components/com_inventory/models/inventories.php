 ...
 */
class InventoryModelinventories extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        $product = $app->getUserStateFromRequest($this->context . '.filter.product', 'filter_product', '', 'string');
    ...
    protected function getListQuery() {
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.title LIKE ' . $search . '  OR  a.description LIKE ' . $search . '  OR  a.cl LIKE ' . $search . ' )');
            }
        }
