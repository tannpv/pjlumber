...
Class FlexicontactViewConfig_List extends JView
{
function display($tpl = null)
{

	JToolBarHelper::title(LAFC_COMPONENT_NAME.': <small><small>'.JText::_('COM_FLEXICONTACT_CONFIGURATION').'</small></small>', 'flexicontact.png');
...
// Set up the configuration links
	...
	$config_table = array(
		...
		array(
			'link' => LAFC_COMPONENT_LINK.'&task=config&view=config_images',
			'icon' => 'config_images.gif',
			'name' => 'COM_FLEXICONTACT_TOOLBAR_IMAGES',
			'desc' => 'COM_FLEXICONTACT_CONFIG_IMAGES_DESC'),
		);
