...
class Facebook
{
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    if (curl_errno($ch) == 60) { // CURLE_SSL_CACERT
      ...
      curl_setopt($ch, CURLOPT_CAINFO, JPATH_ADMINISTRATOR.DS.'components'.DS.'com_phocagallery'.DS.'libraries'.DS.'phocagallery'.DS.'facebook'.DS.'fb_ca_chain_bundle.crt');
      $result = curl_exec($ch);
    }
