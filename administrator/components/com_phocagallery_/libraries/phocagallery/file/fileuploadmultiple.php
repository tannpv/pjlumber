...
class PhocaGalleryFileUploadMultiple
{
	...
	static public function renderMultipleUploadLibraries() {
		...
		$document->addScript(JURI::root(true).'/components/com_phocagallery/assets/jquery/jquery-1.6.4.min.js');
		$nC = 'var pgJQ =  jQuery.noConflict(true);';
		$document->addScriptDeclaration($nC);
