...
<form action="<?php echo JRoute::_('index.php?option=com_manager&view=managers'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    ?>
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td>
                        ...
                        <?php endif; ?>
                        <?php if ($canEdit) : ?>
                            <a href="<?php echo JRoute::_('index.php?option=com_manager&task=manager.edit&id=' . (int) $item->id); ?>">
