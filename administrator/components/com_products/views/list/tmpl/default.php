...
<form action="<?php echo JRoute::_('index.php?option=com_products&view=list'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PRODUCTS_LIST_TITLE', 'a.title', $listDirn, $listOrder); ?>
				</th>
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_products&task=editor.edit&id='.(int) $item->id); ?>">
