...
<body>
	<div id="border-top" class="h_blue">
            <div>
                <div>
                    <span class="title"><a href="index.php"><?php  echo $this->params->get('showSiteName') ? ($app->getCfg('sitename')?$app->getCfg('sitename'):"PJLumber") : JText::_('TPL_BLUESTORK_HEADER'); ?></a></span>
                </div>
            </div>
	</div>
	<div id="content-box">
