...
$menu->addChild(new JMenuNode(JText::_('Photogallery'), 'index.php?option=com_phocagallery'), true);
$menu->getParent();

$menu->addChild(new JMenuNode(JText::_('Inventory'), 'index.php?option=com_inventory'), true);
$menu->getParent();
//
// Site SubMenu
//
if($username == 'admin'){
	if ($user->authorise('core.admin')) {
		...
		$menu->addChild(new JMenuNode(JText::_('MOD_MENU_LOGOUT'), JRoute::_('index.php?option=com_login&task=logout&'. JUtility::getToken() .'=1'), 'class:logout'));
